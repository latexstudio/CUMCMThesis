...
\begin{figure}
    ...
    \begin{minipage}[c]{0.3\textwidth}
        ...
        \subcaption{Caption for image a}
        \label{fig:sample-figure-a}
    \end{minipage}
    \begin{minipage}[c]{0.3\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{f1}
        \subcaption{Caption for image b}
        \label{fig:sample-figure-b}
    \end{minipage}
    \begin{minipage}[c]{0.3\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{f1}
        \subcaption{Caption for image c}
...
\begin{figure}
    ...
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[height=0.3\textheight]{f1}
        \subcaption{Caption for image a}
    \end{minipage}
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[width=0.3\textheight]{gongzhonghao}
        \subcaption{Caption for image b}
    \end{minipage}
    \caption{多图并排示例}
\end{figure}
